...
const TicketControlPage = lazy(() => import('@/components/TicketControlPage'));
...
export const layoutsRoutes = [
  { path: '/', name: 'Login', element: <Navigate to="/basic-login" replace /> },

  { path: '/index', name: 'Inicio', element: <Navigate to="/dashboard" replace /> },
  ...
  { path: '/calendar', name: 'Calendario de servicios', element: <Calender /> },
  { path: '/services-calendar', name: 'Agenda operativa', element: <ServiceCalendarPage /> },
  { path: '/ticket-control', name: 'Asignación y control', element: <TicketControlPage /> },
  ...
  { path: '/clients', name: 'Clients', element: <BackendModule resource="clients" /> },
  { path: '/branches', name: 'Branches', element: <BackendModule resource="branches" /> },
  { path: '/projects', name: 'Projects', element: <BackendModule resource="projects" /> },
  { path: '/tickets', name: 'Tickets', element: <TicketBoardPage /> },
  { path: '/tickets-list', name: 'Gestión de tickets', element: <BackendModule resource="tickets" /> },
  { path: '/client-dashboard', name: 'Portal del cliente', element: <RoleDashboard role="client" /> },
  { path: '/technician-dashboard', name: 'Panel técnico', element: <RoleDashboard role="technician" /> },
  { path: '/dashboard', name: 'Panel principal', element: <AdminDashboardPage /> },
  { path: '/reports', name: 'Reportes', element: <AdminReportsPage /> },
  { path: '/users', name: 'Usuarios y roles', element: <UserRolesPage /> },
  { path: '/notifications', name: 'Notificaciones', element: <SecondaryListPage resource="notifications" /> },
  { path: '/files', name: 'Archivos y evidencias', element: <OperationsPage type="files" /> },
  { path: '/technician-productivity', name: 'Productividad de técnicos', element: <SecondaryListPage resource="reports/technicians" /> },
  { path: '/service-history', name: 'Historial de servicios', element: <OperationsPage type="history" /> },
  { path: '/surveys', name: 'Encuestas de satisfacción', element: <OperationsPage type="surveys" /> },
];
